...
import { CheckCircle, Truck, Recycle, Leaf, Zap, BarChart3 } from "lucide-react"
  ...
  const services = [
    {
      ...
      description: "Comprehensive recycling solutions for businesses of all sizes",
      features: [
    ...
    },
    {
      ...
      features: ["Food waste collection", "Yard waste processing", "Compost production", "Soil amendment services"],
    ...
    },
    {
      ...
      features: ["Electronics collection", "Data destruction", "Component recovery", "Compliance certification"],
    ...
    },
    {
      ...
      features: ["Waste stream analysis", "Sustainability planning", "Cost optimization", "Compliance guidance"],
      image: "/waste-audit-consulting-analysis.jpg",
    },
    {
      icon: CheckCircle,
      title: "Compliance & Reporting",
      description: "Ensure regulatory compliance and track environmental impact",
      features: ["Regulatory compliance", "Impact reporting", "Documentation", "Certification support"],
        ...
        <section className="relative py-20 bg-primary text-primary-foreground">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-lg opacity-90 max-w-2xl mx-auto">
              Comprehensive waste management and recycling solutions tailored to meet your specific needs
            </p>
          </div>
        </section>
              ...
              {[
                {
                  step: "1",
                  title: "Assessment",
                  description: "We evaluate your waste streams and specific needs",
                },
                {
                  step: "2",
                  title: "Planning",
              ...
              {[
                {
                  ...
                  features: ["Weekly collection", "Basic recycling", "Monthly reporting", "Email support"],
                  highlighted: false,
                },
                {
                  name: "Professional",
                ...
                >
                  ...
                  <p className={`mb-6 text-sm ${tier.highlighted ? "opacity-90" : "text-muted-foreground"}`}>
                    {tier.description}
                  </p>
                  <div className="mb-6">
                    <span className="text-4xl font-bold">{tier.price}</span>
                    <span className={`text-sm ${tier.highlighted ? "opacity-90" : "text-muted-foreground"}`}>
                      {tier.period}
                    </span>
                  </div>
        ...
        <section className="py-16 sm:py-24 bg-secondary text-primary-foreground">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-lg opacity-90 mb-8 max-w-2xl mx-auto">
              Contact us today to discuss your waste management needs and find the perfect solution for your business
            </p>
            <Link
              href="/contact"
