      ...
      <main>
        ...
        <section className="relative py-20 bg-primary text-primary-foreground">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 className="text-4xl sm:text-5xl font-bold mb-6">About EcoWaste Solutions</h1>
            <p className="text-lg opacity-90 max-w-2xl mx-auto">
              Pioneering sustainable waste management since 2010, we've been committed to transforming how businesses
              and communities handle their environmental responsibility.
            </p>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-muted-foreground mb-4 leading-relaxed">
                  Founded in 2010, EcoWaste Solutions began with a simple vision: to make sustainable waste management
                  accessible and affordable for everyone. What started as a small local operation has grown into a
                  trusted partner for hundreds of businesses and thousands of households.
                </p>
                <p className="text-muted-foreground mb-4 leading-relaxed">
                  Our journey has been driven by a deep commitment to environmental stewardship and the belief that
                  every action counts. We've invested in cutting-edge technology, trained our team extensively, and
                  continuously innovated our processes to minimize environmental impact.
                </p>
                <p className="text-muted-foreground leading-relaxed">
                  Today, we're proud to have diverted over 50,000 tons of waste from landfills and helped our clients
                  reduce their carbon footprint significantly.
                </p>
              </div>
              <div
